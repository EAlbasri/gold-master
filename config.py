...
SIGNAL_MACRO_VETO_THRESHOLD = int(os.getenv("SIGNAL_MACRO_VETO_THRESHOLD", "86"))
...
PULSE_UPDATE_MINUTES = int(os.getenv("PULSE_UPDATE_MINUTES", "180"))
NEWS_STYLE_UPDATE_MINUTES = int(os.getenv("NEWS_STYLE_UPDATE_MINUTES", "120"))
...
MAX_CANDIDATES_PER_SCAN = int(os.getenv("MAX_CANDIDATES_PER_SCAN", "5"))
